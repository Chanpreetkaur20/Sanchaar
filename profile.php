...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">Events<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="designation"  class="form-control" disabled value="<?php echo htmlentities($result->designation);?>">
	</div>
</div>
